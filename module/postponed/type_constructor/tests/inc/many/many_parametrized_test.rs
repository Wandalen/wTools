...
//     {
//       type Target = the_module ::_Vec < Struct > ; #[ inline ] fn deref( (& self)self ) -> &
//       Self ::Target { & self.0 }
// }
//
//     impl core ::ops ::DerefMut for Structs
//     {
//       #[ inline ] fn deref_mut( (& mut self)mut self ) -> & mut Self ::Target
//       { & mut self.0 }
// }
//
...
//     // where Struct: Clone,
//     { #[ inline ] fn as_slice( (& self)self ) -> & [[ Struct] { & self [..] } }
//

  ...
  [
   {
    ...
    "arguments": [
     ...
     { "name": "arg_multiple", "description": "A multiple string argument", "kind": "List(String)", "attributes": { "optional": false, "multiple": true, "interactive": false, "sensitive": false }, "validation_rules": [], "hint": "Multiple string hint", "aliases": [], "tags": [] },
...
fn test_load_from_json_str_multiple_commands()
{
  ...
  assert_eq!(
  registry.command(".group1.command1_json").unwrap().namespace,
  ".group1".to_string()
  );
  assert_eq!(
  registry.command(".group1.command2_json").unwrap().namespace,
  ".group1".to_string()
  );
}

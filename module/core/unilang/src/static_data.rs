...
//! # Known Pitfalls
//!
//! ## Pitfall: Silent Field Loss in Conversions (Issue-088)
//!
...
//! - Mark critical tests with `// test_kind: bug_reproducer(issue-XXX)`
...
mod private
{
  ...
  impl From< &'static StaticCommandDefinition > for crate::data::CommandDefinition
  {
    fn from( static_cmd : &'static StaticCommandDefinition ) -> Self
    {
      ...
      // Fix(issue-088): Use static_cmd.auto_help_enabled instead of hardcoded false
      //
      // Root cause: Conversion was hardcoding `false`, discarding YAML auto_help_enabled value.
      // This broke .command.help generation for all static commands with auto_help_enabled: true.
      //
      // Pitfall: Any field in StaticCommandDefinition that isnt explicitly copied will be lost

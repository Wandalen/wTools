...
//! as subcomponent_model, enabling fluid and intuitive manipulation of binary heaps via builder patterns.
//!
...
/// Represents the formation definition for a binary heap-like collection within the component_model framework.
///
  ...
  E : Ord
{
  ...
  fn component_model() -> BinaryHeapFormer< E, (), BinaryHeap< E >, ReturnStorage >;
}

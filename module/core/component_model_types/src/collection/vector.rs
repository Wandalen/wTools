...
//! as subcomponent_model, enabling fluid and intuitive manipulation of vectors via builder patterns.
//!
...
/// Represents the formation definition for a vector-like collection within the component_model framework.
///
...
pub trait VecExt< E > : sealed::Sealed
{
  ...
  fn component_model() -> VectorFormer< E, (), Vec< E >, ReturnStorage >;
}

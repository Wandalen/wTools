...
//! as subcomponent_model, enabling fluid and intuitive manipulation of vector deques via builder patterns.
//!
...
/// Represents the formation definition for a vector deque-like collection within the component_model framework.
///
...
pub trait VecDequeExt< E > : sealed::Sealed
{
  ...
  fn component_model() -> VecDequeFormer< E, (), VecDeque< E >, ReturnStorage >;
}

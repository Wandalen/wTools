...
//! as subcomponent_model, enabling fluid and intuitive manipulation of binary tree sets via builder patterns.
//!
...
/// Represents the formation definition for a binary tree set-like collection within the component_model framework.
///
  ...
  E : Ord
{
  ...
  fn component_model() -> BTreeSetFormer< E, (), BTreeSet< E >, ReturnStorage >;
}

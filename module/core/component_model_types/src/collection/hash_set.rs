...
/// Represents the formation definition for a hash set-like collection within the component_model framework.
///
  ...
  K : ::core::cmp::Eq + ::core::hash::Hash,
{
  ...
  fn component_model() -> HashSetFormer< K, (), HashSet< K >, ReturnStorage >;
}

...
//! as subcomponent_model, enabling fluid and intuitive manipulation of hashmaps via builder patterns.
//!
  ...
  K : ::core::cmp::Eq + ::core::hash::Hash,
{
  ...
  fn component_model() -> HashMapFormer< K, E, (), HashMap< K, E >, ReturnStorage >;
}

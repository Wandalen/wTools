...
//! as subcomponent_model, enabling fluid and intuitive manipulation of lists via builder patterns.
//!
...
/// Represents the formation definition for a list-like collection within the component_model framework.
///
...
pub trait LinkedListExt< E > : sealed::Sealed
{
  ...
  fn component_model() -> LinkedListFormer< E, (), LinkedList< E >, ReturnStorage >;
}

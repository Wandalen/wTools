...
//! - **Entity to Former Mapping**: Associating entities with component_models that handle their construction
//!   process.
...
/// Maps a type of entity to its corresponding component_model.
/// This trait binds an entity type to a specific component_model, facilitating the use
/// of custom component_models in complex formation scenarios.
pub trait EntityToFormer< Definition >
where
  Definition : FormerDefinition,
{
  /// The type of the component_model used for building the entity.
  type Former;

...
mod private
{
  ...
  pub trait CollectionValToEntry< Val >
  {
    ...
    /// # Example
    /// ```
    /// use component_model_types::CollectionValToEntry; // use crate `component_model` instead of crate `component_model_types` unless you need to use crate `component_model_types` directly
    ///
    /// struct PairMap;
    ///
  ...
  pub trait ValToEntry< Collection >
  {
    ...
    /// # Example
    /// ```
    /// use component_model_types::ValToEntry; // use crate `component_model` instead of crate `component_model_types` unless you need to use crate `component_model_types` directly
    ///
    /// struct PairMap;
    ///
  ...
  pub trait CollectionAdd : Collection
  {
    ...
    /// ```rust
    ///
    /// use component_model_types::{ Collection, CollectionAdd }; // use crate `component_model` instead of crate `component_model_types` unless you need to use crate `component_model_types` directly
    ///
    /// struct MyCollection
    /// {
    ///   entries : Vec< i32 >,
    ...
    Self : IntoIterator< Item = Self::Entry >,
  {
    ...
    ///
    /// ```rust
    /// use component_model_types::{ Collection, CollectionAssign }; // use crate `component_model` instead of crate `component_model_types` unless you need to use crate `component_model_types` directly
    ///
    /// struct MyCollection
    /// {
    ///   entries : Vec< i32 >,

...
fn main()
{
  ...
  let empty_plain = ColorfulText::from( "" );
  ...
  let ml_plain = ColorfulText::from( "line1\nline2\nline3" );
  println!( "[multiline_uncolored]" );
  println!( "{ml_plain}" );

  let ml_colored = ColorfulText::from( "line1\nline2" ).with_color( "\x1b[33m" );
  ...
  let s : String = ColorfulText::from( "into-test" ).with_color( "\x1b[32m" ).into();
  ...
  #[ cfg( feature = "serde_support" ) ]
  {
    ...
    let restored : ColorfulText = serde_json::from_str( &json ).unwrap();

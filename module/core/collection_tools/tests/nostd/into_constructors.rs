...
fn b_tree_map()
{
  ...
  let got = the_module::into_bmap!{ 3 => 13 };
...
fn hash_map()
{
  ...
  // test.case( "single entry" );
  let got = the_module::into_hmap!{ 3 => 13 };
...
fn hash_set()
{
  ...
  // test.case( "single entry" );
  let got = the_module::into_hset!{ 13 };
...
fn vec_deque()
{
  ...
  // test.case( "single entry" );
  let got : the_module::VecDeque< i32 > = the_module::into_vecd!{ 3, 13 };

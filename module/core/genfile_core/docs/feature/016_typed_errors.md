...
| File | Relationship |
|------|--------------|
| [`src/error.rs`](../../src/error.rs) | Typed error enum definition |

### Tests

| File | Relationship |
|------|--------------|
| [`tests/inc/template_error_test.rs`](../../tests/inc/template_error_test.rs) | Typed error variant and display tests |

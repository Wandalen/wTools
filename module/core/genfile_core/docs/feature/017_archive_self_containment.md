...
- **Purpose**: Ensures a `TemplateArchive` carries all data needed for generation without external dependencies.
...
|------|------|----------------|
| source | `src/archive.rs` | `TemplateArchive` struct and serialization logic |

...
```bash
cd /home/user1/pro/lib/wip_core/wtools/dev/module/core/config_hierarchy
...
[dependencies]
config_hierarchy = { path = "/home/user1/pro/lib/wip_core/wtools/dev/module/core/config_hierarchy", features = ["full"] }
serde_json = "1.0"
EOF

...
| 6 | 006 | 0 | 7 | 7 | 9 | 0 | ✅ (Completed) | any | . | [Complete aspirational test surface — FT-36..FT-40 and FT-29..FT-30](006_aspirational_test_surface.md) | Close spec gap between readme aspirational targets (FT-1..FT-40 / FT-1..FT-30) and current spec files by adding 5 output test cases and 2 help test cases |

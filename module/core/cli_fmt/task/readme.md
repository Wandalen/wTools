...
| 5 | 005 | 9 | 9 | 6 | 9 | 9 | 🎯 (Verified) | AI | . | [Extend CliHelpTemplate — multi-section options, custom usage lines, arguments section](005_extend_cli_help_template_multi_section.md) | Add option_groups, usage_lines, arguments fields to CliHelpData; update render() sequence; bump to 0.9.2 |

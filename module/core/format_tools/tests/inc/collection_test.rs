...
fn hmap_basic()
{
  ...
  use the_module::TableFormatter;
  let _as_table : AsTable< '_, collection_tools::HashMap<  &str, TestObject  >, &str, TestObject, str> = AsTable::new( &data );
  let as_table = AsTable::new( &data );
...
// TODO: Hset doesn't implement required Fields trait for table formatting
// #[ test ]
// fn hset_basic()
// {
//

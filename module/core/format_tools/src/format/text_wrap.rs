...
mod private
{
  ...
  /// in `columns_width_vec` generated by `InputExtract`.
  ///
  /// Notice: data passed to this function should contain only visible rows and columns.
  ///

...
{
  assert_eq!( TheModule::path::is_glob( "file.txt" ), false );
}

#[ test ]
fn path_with_unescaped_glob_star()
{
  assert_eq!( TheModule::path::is_glob( "*.txt" ), true );
}

#[ test ]
fn path_with_escaped_glob_star()
{
  assert_eq!( TheModule::path::is_glob( "\\*.txt" ), false );
}

#[ test ]
fn path_with_unescaped_brackets()
{
  assert_eq!( TheModule::path::is_glob( "file[0-9].txt" ), true );
}

#[ test ]
fn path_with_escaped_brackets()
{
  assert_eq!( TheModule::path::is_glob( "file\\[0-9].txt" ), false );
}

#[ test ]
fn path_with_unescaped_question_mark()
{
  assert_eq!( TheModule::path::is_glob( "file?.txt" ), true );
}
...
{
  assert_eq!( TheModule::path::is_glob( "file{a,b}.txt" ), true );
}

#[ test ]
fn path_with_escaped_braces()
{
  assert_eq!( TheModule::path::is_glob( "file\\{a,b}.txt" ), false );
}

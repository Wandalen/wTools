...
|-----------|------|-------------|---------|----------|
| `name::` | [IdentifierString](../types.md#type-identifierstring) | Archive name (alphanumeric + underscore) | - | ✅ Yes |
| `description::` | [DescriptionText](../types.md#type-descriptiontext) | Human-readable archive description | `""` | No |
...
| Parameter | Type | Description | Default | Required |
|-----------|------|-------------|---------|----------|
| `path::` | [FilePath](../types.md#type-filepath) | Path to archive file (JSON or YAML) | - | ✅ Yes |
| `verbosity::` | [VerbosityLevel](../types.md#type-verbositylevel) | Output detail level (0-5) | `1` | No |
...
| Parameter | Type | Description | Default | Required |
|-----------|------|-------------|---------|----------|
| `path::` | [OutputPath](../types.md#type-outputpath) | Output file path | - | ✅ Yes |
| `format::` | [SerializationFormat](../types.md#type-serializationformat) | Serialization format (json \| yaml) | `json` | No |
| `pretty::` | [PrettyPrintFlag](../types.md#type-prettyprintflag) | Pretty-print JSON (0 or 1) | `1` | No |
| `verbosity::` | [VerbosityLevel](../types.md#type-verbositylevel) | Output detail level (0-5) | `1` | No |
| `dry::` | [DryRunFlag](../types.md#type-dryrunflag) | Preview mode (0 or 1) | `0` | No |

<small>*`verbosity::` is part of [Universal Output Control](../parameter_groups.md#group-1-universal-output-control) parameter group*</small>
<small>*`dry::` is part of [Universal Execution Control](../parameter_groups.md#group-2-universal-execution-control) parameter group*</small>
...
| Parameter | Type | Description | Default | Required |
|-----------|------|-------------|---------|----------|
| `source::` | [DirectoryPath](../types.md#type-directorypath) | Source directory to scan | - | ✅ Yes |
| `mode::` | [ContentMode](../types.md#type-contentmode) | Content mode (inline \| reference) | `reference` | No |
| `recursive::` | [RecursiveFlag](../types.md#type-recursiveflag) | Scan subdirectories (0 or 1) | `1` | No |
| `include_pattern::` | [PatternString](../types.md#type-patternstring) | Include files matching glob pattern | `null` | No |
| `exclude_pattern::` | [PatternString](../types.md#type-patternstring) | Exclude files matching glob pattern | `null` | No |
| `verbosity::` | [VerbosityLevel](../types.md#type-verbositylevel) | Output detail level (0-5) | `1` | No |

<small>*`recursive::`, `include_pattern::`, `exclude_pattern::` are part of [Filesystem Filtering](../parameter_groups.md#group-3-filesystem-filtering) parameter group*</small>
<small>*`verbosity::` is part of [Universal Output Control](../parameter_groups.md#group-1-universal-output-control) parameter group*</small>

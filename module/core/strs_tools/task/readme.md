...
|-------|-----|--------------|-------|----------|--------|----------|-------|----------|-----|------|---------|
| 1 | [012](unverified/012_create_test_surface_and_fill_coverage_gaps.md) | 864 | 8 | 6 | 9 | 2 | ❓ (Unverified) | any | module/core/strs_tools | Create test surface and fill coverage gaps | Create tests/docs/ specs and fill 3 remaining coverage gaps (SIMD, indentation expansion, number parsing expansion) |
| 2 | [011](unverified/011_add_visual_width_display_columns.md) | 972 | 6 | 9 | 9 | 2 | ❓ (Unverified) | any | module/core/strs_tools | Add visual_width display columns | Add `visual_width()` using display-column measurement to fix visual_len/pad_to_width mismatch |

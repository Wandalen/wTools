...
| 002 | [Feature Gating Contract](002_feature_gating_contract.md) | Guarantee that capabilities are individually feature-gated with workspace-standard enabled/full pattern | ✅ |

...
- **API reference**: See `api/` for type signatures and formatter APIs
- **Features**: See `feature/` for capability descriptions and usage
- **Invariants**: See `invariant/` for behavioral contracts and guarantees
- **User guide**: See `../readme.md` for examples and quick start
...
| `feature_refactoring_plan.md` | Plan for restructuring feature flag organization |

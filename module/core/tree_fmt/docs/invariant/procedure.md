...
3. Create `docs/invariant/NNN_name.md` with the following sections in order: `### Scope`, `### Cross-References`, `### Statement` (measurable form), `### Enforcement` (how it is monitored or tested), `### Violation Consequences`.

# ANSI and Unicode Invariants

## Purpose

Defines the contracts for ANSI escape sequence handling, Unicode display width calculation, and terminal-safe color output in tree_fmt.

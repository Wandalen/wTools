...
Configure and render tabular data with 9 style presets, multiline cell support, column truncation, ANSI-aware coloring, border variant rendering, and sub-row detail lines.

...
Provide predefined, professionally designed color schemes for visual formatters (Table, Expanded, Tree) with consistent styling and no manual ANSI code management.

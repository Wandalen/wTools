...
impl<E, Context, Formed> FormerMutator for VecDequeDefinitionTypes<E, Context, Formed> {}
...
impl<E> crate::EntityToStorage for VecDeque<E> {
  type Storage = VecDeque<E>;
}

impl<E, Context, Formed, End> crate::EntityToDefinition<Context, Formed, End> for VecDeque<E>
where
...
impl<E, Context, Formed> crate::EntityToDefinitionTypes<Context, Formed> for VecDeque<E> {
  type Types = VecDequeDefinitionTypes<E, Context, Formed>;
}
...
///
pub type VecDequeFormer<E, Context, Formed, End> = CollectionFormer<E, VecDequeDefinition<E, Context, Formed, End>>;

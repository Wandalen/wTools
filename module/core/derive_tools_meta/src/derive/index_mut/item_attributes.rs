...
pub struct ItemAttributes
{
  ...
  pub index_mut : ItemAttributeIndexMut,
...
#[ derive( Debug, Default ) ]
pub struct ItemAttributeIndexMut
{
  /// Specifies what specific named field must implement IndexMut.
...
impl ItemAttributes
{
  ...
  pub fn from_attrs< 'a >( attrs : impl Iterator< Item = & 'a syn::Attribute > ) -> Result< Self >
  {
    ...
    for attr in attrs
    {
      ...
      {
         ItemAttributeIndexMut::KEYWORD => result.assign( ItemAttributeIndexMut::from_meta( attr )? ),
        "debug" => {},
        _ => {},
...
impl AttributeComponent for ItemAttributeIndexMut
{
  ...
  fn from_meta( attr : &syn::Attribute ) -> Result< Self >
  {
    match attr.meta
    {
      ...
      {
        return syn::parse2::< ItemAttributeIndexMut >( meta_list.tokens.clone() );
      },
...
impl< IntoT > Assign< ItemAttributeIndexMut, IntoT > for ItemAttributes
where
  IntoT : Into< ItemAttributeIndexMut >,
{
  #[ inline( always ) ]
...
impl< IntoT > Assign< ItemAttributeIndexMut, IntoT > for ItemAttributeIndexMut
where
  IntoT : Into< ItemAttributeIndexMut >,
{
  #[ inline( always ) ]
...
impl< IntoT > Assign< AttributePropertyName, IntoT > for ItemAttributeIndexMut
where
...
impl syn::parse::Parse for ItemAttributeIndexMut
{
  fn parse( input : syn::parse::ParseStream< '_ > ) -> syn::Result< Self >
  {
    ...
    let error = | ident : &syn::Ident | -> syn::Error
    {
      ...
      (
        "Known entries of attribute ", ItemAttributeIndexMut::KEYWORD, " are : ",

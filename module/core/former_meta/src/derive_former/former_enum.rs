        ...
        match fields.named.len()
        {
            ...
            _ => // len > 1
            {
                ...
                else // Default: Subformer
                {
                    ...
                    // Generate storage fields: pub field_name : Option<FieldType>, ...
                    ...
                    // Generate default assignments: field_name : None, ...
                    ...
                    // Generate Storage struct definition
                    ...
                    // Generate StoragePreform trait impl
                    let preform_field_assignments = variant_field_info.iter().map( |f_info|
                    {
                      let field_ident = &f_info.ident;
                      let field_type = &f_info.ty;
                      // Logic to unwrap Option or use default
                      quote!
                      {
                        ...
                        {
                          // Use Default trait if available, otherwise panic (handled by MaybeDefault trick)
                          {
                    ...
                    // FIX: Collect into Vec to avoid consuming iterator
                    ...
                    let storage_preform_impl = quote!
                    {
                      ...
                      { // Brace on new line
                        ...
                        { // Brace on new line
                          // FIX: Use the collected Vec here
                          #( let #preformed_tuple_elements_vec = #preform_field_assignments; )*
                          // FIX: Use the collected Vec here too
                          ( #( #preformed_tuple_elements_vec ),* ) // Return the tuple
                        } // Brace on new line
                      } // Brace on new line
                    };

                    // Generate DefinitionTypes struct and impls
                    ...
                    if enum_name == "EnumG4" && variant_ident == "V1"
                    {
                      ...
                      // Combine all generated parts for this variant for printing
                      let variant_code = quote!
                      {
                        // Associated Method (Placeholder - will be generated later)
                        // fn v_1() -> ... {}

...
This directory contains the core implementation of the `claude_runner` crate, providing builder pattern API for executing Claude Code commands programmatically.
...
- Actual process execution (→ dream_agent crate, command.rs only builds commands)
...
- **Total**: 20 test files, all passing; see tests/readme.md and spec.md NFR-6 for counts

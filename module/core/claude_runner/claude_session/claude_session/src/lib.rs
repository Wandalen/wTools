...
//! use the `claude_runner` crate which provides a builder pattern API.
//!
//! # Modules
//!
...
//!
//! // NOTE: For execution, use claude_runner::ClaudeCommand
//! // See claude_runner crate documentation for execution examples.
//! # Ok::<(), std::io::Error>(())
//! ```
//!

...
fn create_test_entry( entry_type : &str, content : &str, uuid : &str ) -> String
{
  ...
  format!
  (
    r#"{{"type":"{}","uuid":"{}","parentUuid":null,"timestamp":"2025-11-29T10:00:00Z","cwd":"/tmp/test","sessionId":"test-session","version":"2.0.0","gitBranch":"master","userType":"external","isSidechain":false,"message":{{"role":"{}","content":"{}"}}}}"#,
    entry_type, uuid, role, content
  )
}

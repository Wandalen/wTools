# Manual Testing - claude_runner

This directory contains manual testing procedures, plans, and results for the `claude_runner` crate.
...
```bash
cd /home/user1/pro/lib/wip_core/wtools/dev/module/core/claude_runner

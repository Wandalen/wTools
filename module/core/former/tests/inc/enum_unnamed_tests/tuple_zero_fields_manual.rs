...
impl EnumWithZeroFieldTuple {
    ...
    #[inline(always)]
    pub fn variant_zero_scalar() -> Self { // Manual equivalent of scalar behavior
...
#[inline(always)]
pub fn variant_zero_default() -> EnumWithZeroFieldTuple { // Name matches derive output
    EnumWithZeroFieldTuple::VariantZeroDefault
}

#[inline(always)]
pub fn variant_zero_scalar() -> EnumWithZeroFieldTuple { // Name matches derive output

...
// mod basic_derive;  // Temporarily disabled due to inner struct derive issues
// mod basic_manual;
...
// mod generics_shared_tuple_derive;  // Temporarily disabled due to E0392 generic issue
...
// mod usecase1_derive;  // Temporarily disabled due to inner struct derive issues
// mod usecase1_manual;

  ...
  K : core::hash::Hash + std::cmp::Eq
{
  ...
  #[ inline( always ) ]
  pub fn former() -> HashMapWrapFormer< K, E, (), impl OnEnd< std::collections::HashMap< K, E >, () > >
  {
...
pub struct HashMapWrapFormer< K, E, Context = (), OnEnd = NoEnd >
where
  K : core::hash::Hash + std::cmp::Eq,
{
  container : core::option::Option< std::collections::HashMap< K, E > >,
  context : core::option::Option< Context >,
  on_end : core::option::Option< OnEnd >,
...
where
  ...
  P : OnEnd< std::collections::HashMap< K, E >, Context >,
{

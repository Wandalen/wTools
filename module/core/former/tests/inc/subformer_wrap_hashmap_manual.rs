// xxx : finish
use super::*;
use former::runtime::{ OnEnd, JustContainerEnd };
...
pub struct HashMapWrapFormer< K, E, Context = std::collections::HashMap< K, E >, P = JustContainerEnd >
where
  K : core::hash::Hash + std::cmp::Eq,
  P : OnEnd< core::option::Option< std::collections::HashMap< K, E > >, core::option::Option< Context > >,
  // P : OnEnd< core::option::Option< std::collections::HashMap< K, E > >, core::option::Option< Context > >,
{
  ...
  P : OnEnd< core::option::Option< std::collections::HashMap< K, E > >, core::option::Option< Context > >,
{
  ...
  pub fn end( mut self ) -> Context
  {
    ...
    on_end.call( Some( container ), context ).expect( "Context" )
  }
...
// OnEnd< core::option::Option< std::collections::HashMap< K, E > >, core::option::Option< Context > >

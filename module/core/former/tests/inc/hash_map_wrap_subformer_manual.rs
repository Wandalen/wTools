  ...
  K : core::hash::Hash + std::cmp::Eq
{
  ...
  {
    HashMapWrapFormer::< K, E, (), NoPerform >::new
    (
...
pub struct HashMapWrapFormer< K, E, Context = (), Perform = NoPerform >
where
  K : core::hash::Hash + std::cmp::Eq
{
  container : core::option::Option< std::collections::HashMap< K, E > >,
  context : core::option::Option< Context >,
  on_perform : core::option::Option< Perform >,
  ...
  P : Perform< std::collections::HashMap< K, E >, Context >,
{
  ...
  {
    // xxx : call form first
    let on_perform = self.on_perform.take().unwrap();
    let context = self.context.take().unwrap();
    let container = self.form();

    on_perform.call( container, context )

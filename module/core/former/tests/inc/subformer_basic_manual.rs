...
pub struct CommandFormer< K, Context = Command< K >, End = ReturnContainer >
where
  K : core::hash::Hash + std::cmp::Eq,
  End : ToSuperFormer< Command< K >, Context >,
{
  ...
  End : ToSuperFormer< Command< K >, Context >,
{
  ...
  <
    ...
    CommandFormer< K, Context, End >,
    impl ToSuperFormer< std::collections::HashMap< K, Property< K > >, Self >,
...
// generated by former
// #[ derive( Debug, Default ) ]
pub struct AggregatorFormer< K, Context = Aggregator< K >, End = ReturnContainer >
where
  K : core::hash::Hash + std::cmp::Eq,
  End : ToSuperFormer< Aggregator< K >, Context >,
{
  ...
  End : ToSuperFormer< Aggregator< K >, Context >,
{
  ...
  <
    ...
    impl ToSuperFormer< std::collections::HashMap< String, Command< K > >, Self >,
  >
  {
  ...
  #[ inline( always ) ]
  pub fn command( self, name : String ) -> CommandFormer< K, Self, impl ToSuperFormer< Command< K >, Self > >
  where
    K : core::hash::Hash + std::cmp::Eq,
  {

...
//   }
//
//   #[ doc = "Setter for the 'hashmap_1' field." ]
//   #[ inline ]
//   pub fn hashmap_1< Src >( mut self, src: Src ) -> Self
//   where
//     Src: ::core::convert::Into< std::collections::HashMap< String, String > >,
//   {
//     debug_assert!( self.storage.hashmap_1.is_none() );
//     self.storage.hashmap_1 = ::core::option::Option::Some( ::core::convert::Into::into( src ) );
//     self
//   }
//
//   #[ inline( always ) ]
...
// {
//   #[ inline( always ) ]
//   fn call( &self, storage: std::collections::HashSet< String >, super_former: Option< Struct1Former< Definition > >, )

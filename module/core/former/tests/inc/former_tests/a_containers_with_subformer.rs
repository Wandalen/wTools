...
} #[derive(Debug)] pub struct Struct1FormerDefinitionTypes < Context = (),
Formed = Struct1 >
{ _phantom : core :: marker :: PhantomData < (Context, Formed) >, } impl <
Context, Formed > Default for Struct1FormerDefinitionTypes < Context, Formed >
{
    fn default() -> Self
...
Struct1FormerDefinitionTypes < Context, Formed >
{
...
FormingEnd < Struct1FormerDefinitionTypes < Context, Formed > >,
{
    type Types = Struct1FormerDefinitionTypes < Context, Formed > ; type End =
    End ;
} pub type Struct1FormerWithClosure < Context, Formed > =
Struct1FormerDefinition < Context, Formed, former :: FormingEndClosure <
Struct1FormerDefinitionTypes < Context, Formed > > > ;
...
StoragePreform,
{
    ...
    } #[inline(always)] pub fn vec_1_set < Former2 > (self) -> Former2 where
    Former2 : former :: FormerBegin < former :: VectorDefinition < String,
    Self, Self, Struct1Formervec1End, > >,
    { Former2 :: _begin(None, Some(self), Struct1Formervec1End) } pub fn
    vec_1(self) -> former :: ContainerSubformer :: < String, former ::
    VectorDefinition < String, Self, Self, Struct1Formervec1End > >
    {
        self.vec_1_set :: < former :: ContainerSubformer :: < String, former
        :: VectorDefinition < String, Self, Self, Struct1Formervec1End > >> ()
    } #[inline(always)]
    ...
    String, String, Self, Self, Struct1Formerhashmap1End, > >,
    { Former2 :: _begin(None, Some(self), Struct1Formerhashmap1End) }

    pub fn
    hashmap_1(self) -> former :: ContainerSubformer :: < ( String, String ),
    former :: HashMapDefinition < String, String, Self, Self,
    Struct1Formerhashmap1End > >
    {
        self.hashmap_1_set :: < former :: ContainerSubformer :: < ( String,
        String ), former :: HashMapDefinition < String, String, Self, Self,
        Struct1Formerhashmap1End > >> ()
    }
    ...
    String, Self, Self, Struct1Formerhashset1End, > >,
    { Former2 :: _begin(None, Some(self), Struct1Formerhashset1End) } pub fn
    hashset_1(self) -> former :: ContainerSubformer :: < ( String ), former ::
    HashSetDefinition < ( String ), Self, Self, Struct1Formerhashset1End > >
    {
        self.hashset_1_set :: < former :: ContainerSubformer :: < ( String ),
...
Storage = Struct1FormerStorage, Formed = Struct1 >, < Definition :: Types as
former :: FormerDefinitionTypes > :: Storage : former :: StoragePreform,
{
...
#[allow(non_camel_case_types)] pub struct Struct1Formervec1End ;
...
Definition >, former :: NoEnd >, > for Struct1Formervec1End where Definition :
...
#[allow(non_camel_case_types)] pub struct Struct1Formerhashmap1End ;
#[automatically_derived] impl < Definition > former :: FormingEnd < former ::
HashMapDefinition < String, String, Struct1Former < Definition >,
Struct1Former < Definition >, former :: NoEnd >, > for
Struct1Formerhashmap1End where Definition : former :: FormerDefinition,
...
#[allow(non_camel_case_types)] pub struct Struct1Formerhashset1End ;
#[automatically_derived] impl < Definition > former :: FormingEnd < former ::
HashSetDefinition < String, Struct1Former < Definition >, Struct1Former <
Definition >, former :: NoEnd >, > for Struct1Formerhashset1End where
Definition : former :: FormerDefinition, Definition :: Types : former ::
FormerDefinitionTypes < Storage = Struct1FormerStorage >,
{
    #[inline(always)] fn

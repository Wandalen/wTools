  ...
  Definition : former::FormerDefinition< Storage = < Aggregator as former::EntityToStorage >::Storage >,
{
  ...
  #[ inline( always ) ]
  pub fn command2( self, name : &str ) -> CommandAsSubformer< Self, impl CommandAsSubformerEnd< Self > >
  {
...
// == begin of generated
  ...
  } impl < Definition > former :: EntityToFormer < Definition > for Aggregator <
  ...
  FormerDefinitionTypes < Storage = AggregatorFormerStorage < > > ,
  {
      ...
      } #[doc = "Setter for the 'command' field."]


      #[inline] pub fn command <
  ...
  Context = AggregatorFormer < Definition, > , > ,
  {
      ...
      :: Option < Types2 :: Context > ,) -> Types2 :: Formed
      {
          ...
          {
              former :: ContainerAdd ::
              add(field, < < HashMap < String, Command > as former :: Container
              > :: Val as former :: ValToElement < HashMap < String, Command > >
              > ::

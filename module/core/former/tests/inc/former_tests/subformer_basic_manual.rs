  ...
  End : the_module::ToSuperFormer< Command< K >, Context >,
{
  ...
  >
  {
    ...
    let on_end = | container : collection_tools::HashMap< K, Property< K > >, super_former : core::option::Option< Self > | -> Self
    {
...
// generated by former
// #[ derive( Debug, Default ) ]
pub struct AggregatorFormer< K, Context = Aggregator< K >, End = the_module::ReturnContainer >
where
  K : core::hash::Hash + std::cmp::Eq,
  ...
  End : the_module::ToSuperFormer< Aggregator< K >, Context >,
{
  ...
  >
  {
    ...
    let on_end = | container : collection_tools::HashMap< String, Command< K > >, super_former : core::option::Option< Self > | -> Self
    {
      let mut super_former = super_former.unwrap();

...
pub struct CommandFormer< K, Context = Command< K >, End = the_module::ReturnPreformed >
where
  K : core::hash::Hash + std::cmp::Eq,
...
// generated by former
// #[ derive( Debug, Default ) ]
pub struct AggregatorFormer< K, Context = Aggregator< K >, End = the_module::ReturnPreformed >
where
  K : core::hash::Hash + std::cmp::Eq,

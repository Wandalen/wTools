...
#[automatically_derived] impl < 'a > Struct1 < 'a >
{
    #[doc = r""]
    #[doc =
...
Formed > { _phantom : core :: marker :: PhantomData < (Context, Formed) >, }
impl < 'a, Context, Formed > Default for Struct1FormerDefinitionTypes < 'a,
Context, Formed >
{
    fn default() -> Self
...
End > { _phantom : core :: marker :: PhantomData < (Context, Formed, End) >, }
impl < 'a, Context, Formed, End > Default for Struct1FormerDefinition < 'a,
Context, Formed, End >
{
    fn default() -> Self
    { Self { _phantom : core :: marker :: PhantomData, } }
...
pub type Struct1FormerWithClosure
< 'a, Context, Formed > = Struct1FormerDefinition < Context, Formed, former :: FormingEndClosure <
Struct1FormerDefinitionTypes < 'a, Context, Formed > > > ;


#[doc = "Container of a corresponding former."] pub struct
Struct1FormerStorage < 'a >
{
...
Struct1FormerStorage < 'a >
{
    fn preform(mut self) -> < Self as former :: Storage > :: Formed
    {
        ...
        } ; let result = Struct1 :: < 'a > { string_slice_1, } ; return result
        ;
    }
}
#[doc =
...
Struct1, former :: ReturnPreformed > > where Definition : former ::

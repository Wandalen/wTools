...
//       }
//       #[doc =
//       "Subformer setter for the 'vec_1' field. Method _vec_1_assign unlike method vec_1 accept custom container subformer."]
//       #[inline(always)] pub fn _vec_1_assign < Former2 > (self) -> Former2 where
//       Former2 : former :: FormerBegin < < Vec < String > as former ::
//       EntityToDefinition < Self, Self, Struct1FormerAssignVec1End > > ::
//       Definition > ,
//       { Former2 :: former_begin(None, Some(self), Struct1FormerAssignVec1End) }
//       #[doc =
//       "Subformer setter for the 'vec_1' field. Method _vec_1_assign unlike method vec_1 accept custom container subformer."]
//       #[inline(always)] pub fn vec_1(self) -> former :: ContainerSubformer :: <
//       String, < Vec < String > as former :: EntityToDefinition < Self, Self,
//       Struct1FormerAssignVec1End > > :: Definition >
//       {
//           self._vec_1_assign :: < former :: ContainerSubformer :: < String, <
//           Vec < String > as former :: EntityToDefinition < Self, Self,
//           Struct1FormerAssignVec1End > > :: Definition >> ()
//       }
//       #[doc =
//       "Subformer setter for the 'hashmap_1' field. Method _hashmap_1_assign unlike method hashmap_1 accept custom container subformer."]
//       #[inline(always)] pub fn _hashmap_1_assign < Former2 > (self) -> Former2
...
//       }
//       #[doc =
//       "Subformer setter for the 'hashset_1' field. Method _hashset_1_assign unlike method hashset_1 accept custom container subformer."]
//       #[inline(always)] pub fn _hashset_1_assign < Former2 > (self) -> Former2
...
//       {
//           self._hashset_1_assign :: < former :: ContainerSubformer :: < String,
...
//     Definition :: Types : former :: FormerDefinitionTypes < Storage = Struct1FormerStorage < > > , Definition : former :: FormerDefinition,

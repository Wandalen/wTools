...
//   ChildFormerStorage < 'child, T, > > , T : 'child,
//   { type Former = ChildFormer < 'child, T, Definition > ; } impl < 'child, T, >
//   former :: EntityToStorage for Child < 'child, T, > where T : 'child,
...
//   < ChildFormerDefinitionTypes < 'child, T, __Context, __Formed > > , T :
//   'child,
//   {
//       type Definition = ChildFormerDefinition < 'child, T, __Context, __Formed,
//       __End > ;
//   } #[derive(Debug)] pub struct ChildFormerDefinitionTypes < 'child, T,
//   __Context = (), __Formed = Child < 'child, T, > , > where T : 'child,
//   {
//       _phantom : core :: marker :: PhantomData <
//       (& 'child (), T, __Context, __Formed) > ,
...
//   'child,
//   {
//       type Storage = ChildFormerStorage < 'child, T, > ; type Formed = __Formed;
//       type Context = __Context;
//   } #[derive(Debug)] pub struct ChildFormerDefinition < 'child, T, __Context =
//   (), __Formed = Child < 'child, T, > , __End = former :: ReturnPreformed, >
//   where T : 'child,
//   {
//       _phantom : core :: marker :: PhantomData <
//       (& 'child (), T, __Context, __Formed, __End) > ,
...
//   for ChildFormerDefinition < 'child, T, __Context, __Formed, __End, > where
//   __End : former :: FormingEnd < ChildFormerDefinitionTypes < 'child, T,
//   __Context, __Formed, > > , T : 'child,
//   {
//       type Types = ChildFormerDefinitionTypes < 'child, T, __Context, __Formed,
//       > ; type End = __End; type Storage = ChildFormerStorage < 'child, T, > ;
...
//   #[ allow( explicit_outlives_requirements ) ]
//   pub struct
//   ChildFormerStorage < 'child, T, > where T : 'child,
//   {
//       #[doc = r" A field"] pub name : :: core :: option :: Option < String > ,
//       #[doc = r" A field"] pub arg : :: core :: option :: Option < & 'child T >
//       ,
//   } impl < 'child, T, > :: core :: default :: Default for ChildFormerStorage <
//   'child, T, > where T : 'child,
//   {
...
//   where T : 'child, { type Formed = Child < 'child, T, > ; } impl < 'child, T, >
//   former :: StoragePreform for ChildFormerStorage < 'child, T, > where T :
//   'child,
//   {
...
//   : 'child, Definition : former :: FormerDefinition, Definition :: Types :
...
//   'child, T, Definition, > where T : 'child, Definition : former ::
...
//   'child, Definition : former :: FormerDefinition, Definition :: Types : former
//   :: FormerDefinitionTypes < Storage = ChildFormerStorage < 'child, T, > > ,
//   {
...
//   Self : former :: FormingEnd < ChildFormerDefinitionTypes < 'child, T,
//   SuperFormer, SuperFormer > , > , {} impl < 'child, T, SuperFormer, __T >
//   ChildAsSubformerEnd < 'child, T, SuperFormer > for __T where T : 'child, Self
//   : former :: FormingEnd < ChildFormerDefinitionTypes < 'child, T, SuperFormer,
//   SuperFormer > , > , {}

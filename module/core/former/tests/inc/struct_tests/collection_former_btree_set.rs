...
fn add() {
  ...
  let got: BTreeSet< String > = the_module::CollectionFormer::<
    String,
    former::BTreeSetDefinition<String, (), BTreeSet< String >, the_module::ReturnStorage>,
  >::new(former::ReturnStorage)
  .add("a")
  .add("b")
  .form();
  let exp = collection_tools::bset!["a".to_string(), "b".to_string(),];
  a_id!(got, exp);

  // explicit with BTreeSetFormer

  let got: BTreeSet< String > =
    the_module::BTreeSetFormer::<String, (), BTreeSet< String >, the_module::ReturnStorage>::new(former::ReturnStorage)
      .add("a")
      .add("b")
      .form();
  let exp = collection_tools::bset!["a".to_string(), "b".to_string(),];
  ...
  let got: BTreeSet< String > = the_module::BTreeSetFormer::begin(
    Some(collection_tools::bset!["a".to_string()]),
    Some(()),
  ...
  let got: BTreeSet< String > = BTreeSet::former().add("a").add("b").form();
  let exp = collection_tools::bset!["a".to_string(), "b".to_string(),];
  a_id!(got, exp);
...
#[ test ]
fn entity_to() {
  let got = <BTreeSet< i32 > as former::EntityToFormer<
    former::BTreeSetDefinition<i32, (), BTreeSet< i32 >, former::ReturnStorage>,
  ...
  let exp = <BTreeSet< i32 > as former::EntityToFormer<
    former::BTreeSetDefinition<i32, (), BTreeSet< i32 >, former::ReturnStorage>,
  >>::Former::new(former::ReturnStorage)
  .form();
  a_id!(got, exp);

...
impl former::FormerMutator for Return13 {}
...
impl former::FormingEnd<Return13> for Return13 {
  fn call(
    &self,
...
impl<E> former::FormerMutator for Return13Generic<E> {}
...
impl<E> the_module::FormingEnd<Return13Generic<E>> for Return13Generic<E> {
  fn call(
    &self,
...
fn definitions() {
  ...
  f3::<
    <former::VectorDefinition<String, (), Vec<String>, the_module::NoEnd> as the_module::FormerDefinition>::Types,
...
fn begin_and_custom_end() {
  ...
  let got = the_module::VectorFormer::new(return_13).add("a").add("b").form();
  let exp = 13.1;
  a_id!(got, exp);

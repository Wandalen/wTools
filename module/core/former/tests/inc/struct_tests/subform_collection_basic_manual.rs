...
#[allow(dead_code)]
pub type Struct1AsSubformer<Superformer, End> = Struct1Former<Struct1FormerDefinition<Superformer, Superformer, End>>;
...
impl<SuperFormer, T> Struct1AsSubformerEnd<SuperFormer> for T where
  Self: former::FormingEnd<Struct1FormerDefinitionTypes<SuperFormer, SuperFormer>>
{
}
...
impl<Definition> former::FormingEnd<former::VectorDefinitionTypes<String, Struct1Former<Definition>, Struct1Former<Definition>>>
  ...
  Definition::Types: former::FormerDefinitionTypes<Storage = Struct1FormerStorage>,
{
  ...
  fn call(
    &self,
    storage: collection_tools::Vec<String>,
...
impl<Definition>
  former::FormingEnd<former::HashMapDefinitionTypes<String, String, Struct1Former<Definition>, Struct1Former<Definition>>>
...
impl<Definition> former::FormingEnd<former::HashSetDefinitionTypes<String, Struct1Former<Definition>, Struct1Former<Definition>>>

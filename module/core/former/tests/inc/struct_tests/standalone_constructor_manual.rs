...
impl<Context, Formed> FormerDefinitionTypes for TestStructNoArgsFormerDefinitionTypes<Context, Formed> {
  type Storage = TestStructNoArgsFormerStorage;
  type Formed = Formed;
  type Context = Context;
}

impl<Context, Formed> FormerMutator for TestStructNoArgsFormerDefinitionTypes<Context, Formed> {}
...
impl<Context, Formed, End> FormerDefinition for TestStructNoArgsFormerDefinition<Context, Formed, End>
where
...
impl<C, F> FormerDefinitionTypes for TestStructWithArgsFormerDefinitionTypes<C, F> {
...
impl<C, F, E> FormerDefinition for TestStructWithArgsFormerDefinition<C, F, E>
where

...
fn add() {
  ...
  let got: LinkedList<String> = the_module::CollectionFormer::<
    String,
    former::LinkedListDefinition<String, (), LinkedList<String>, the_module::ReturnStorage>,
  >::new(former::ReturnStorage)
  .add("a")
  .add("b")
  .form();
  let exp = collection_tools::llist!["a".to_string(), "b".to_string(),];
  a_id!(got, exp);

  // explicit with LinkedListFormer

  let got: LinkedList<String> =
    the_module::LinkedListFormer::<String, (), LinkedList<String>, the_module::ReturnStorage>::new(former::ReturnStorage)
      .add("a")
      .add("b")
      .form();
  let exp = collection_tools::llist!["a".to_string(), "b".to_string(),];
  ...
  let got: LinkedList<String> = the_module::LinkedListFormer::begin(
    Some(collection_tools::llist!["a".to_string()]),
    Some(()),
  ...
  let got: LinkedList<String> = LinkedList::former().add("a").add("b").form();
  let exp = collection_tools::llist!["a".to_string(), "b".to_string(),];
  a_id!(got, exp);
...
fn entity_to() {
  ...
  let exp = <LinkedList<i32> as former::EntityToFormer<
    former::LinkedListDefinition<i32, (), LinkedList<i32>, former::ReturnPreformed>,
  >>::Former::new(former::ReturnPreformed)
  .form();
  a_id!(got, exp);

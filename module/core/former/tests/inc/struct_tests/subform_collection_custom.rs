...
impl<K> former::Storage for LoggingSet<K>
where
  K: ::core::cmp::Eq + ::core::hash::Hash,
{
...
impl<K> former::StoragePreform for LoggingSet<K>
where
  K: ::core::cmp::Eq + ::core::hash::Hash,
{
...
impl<K, Context, Formed> former::FormerDefinitionTypes for LoggingSetDefinitionTypes<K, Context, Formed>
where
  K: ::core::cmp::Eq + ::core::hash::Hash,
{
...
impl<K, Context, Formed, End> former::FormerDefinition for LoggingSetDefinition<K, Context, Formed, End>
where
  K: ::core::cmp::Eq + ::core::hash::Hash,
...
impl<K, Context, Formed> former::FormerMutator for LoggingSetDefinitionTypes<K, Context, Formed> where
  K: ::core::cmp::Eq + ::core::hash::Hash
{
}
...
impl<K> former::EntityToStorage for LoggingSet<K>
where
  K: ::core::cmp::Eq + ::core::hash::Hash,
{
  type Storage = LoggingSet<K>;
...
impl<K, Context, Formed, End> former::EntityToDefinition<Context, Formed, End> for LoggingSet<K>
where
  K: ::core::cmp::Eq + ::core::hash::Hash,
  End: former::FormingEnd<LoggingSetDefinitionTypes<K, Context, Formed>>,
{
...
impl<K, Context, Formed> former::EntityToDefinitionTypes<Context, Formed> for LoggingSet<K>
where
  K: ::core::cmp::Eq + ::core::hash::Hash,
{
  type Types = LoggingSetDefinitionTypes<K, Context, Formed>;

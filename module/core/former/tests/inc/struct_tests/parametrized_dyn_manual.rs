...
// Fix: FormerBegin now requires lifetime parameter
impl< 'callback, 'storage, Definition > former::FormerBegin< 'storage, Definition > for StylesFormer< 'callback, Definition >
where
  Definition: former::FormerDefinition< Storage = StylesFormerStorage< 'callback > >,
  'callback: 'storage,

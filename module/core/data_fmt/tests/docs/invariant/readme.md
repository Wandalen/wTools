...
- **In Scope**: IN-N invariant enforcement cases in Given/When/Then format for all 5 invariant elements; minimum 2 cases per spec; behavioral guarantees that must hold across all rendering scenarios.
...
| 005 | [Heading Rendering](005_caption.md) | Invariant spec for heading rendering guarantees | 2 ✅ 1 ⏳ |

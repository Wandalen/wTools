...
- **In Scope**: FT-N feature test cases in Given/When/Then format for all 6 feature elements; minimum 4 cases per spec; behavioral contracts that must hold across all supported use cases.

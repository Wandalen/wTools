...
- **In Scope**: AC-N correctness test cases in Given/When/Then format for all 7 algorithm elements; minimum 4 cases per spec; edge cases and error paths documented in source algorithm docs.
...
| 007 | [Heading Rendering](007_caption_rendering.md) | Algorithm spec for heading line assembly | 3 ✅ 4 ⏳ |

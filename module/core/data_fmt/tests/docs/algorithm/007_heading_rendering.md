...
- **Responsibility**: Documents test cases for the heading rendering algorithm in `docs/algorithm/007_heading_rendering.md`.
...
| File | Relationship |
|------|-------------|
| [`docs/algorithm/007_heading_rendering.md`](../../../docs/algorithm/007_heading_rendering.md) | Source algorithm spec — heading content string, lead prefix, trailing rule computation |

...
| `table_footer_test.rs` | Test TableConfig::with_footer() builder API and heading+footer coexistence |
...
### Core Data Structures (data.rs - 18 tests)
...
### Fluent APIs (fluent_api.rs - 9 tests)

...
fn main()
{
  ...
  let help_view = RowBuilder::new( vec![ "Term".into(), "Description".into() ] )
    .add_row( vec![ "USAGE".into(), String::new().into() ] )
    .add_row( vec![ "myapp [command] [options]".into(), String::new().into() ] )
    .add_row( vec![ "COMMANDS".into(), String::new().into() ] )
    ...
    .add_row( vec![ "OPTIONS".into(), String::new().into() ] )
    ...
    .add_row( vec![ "EXAMPLES".into(), String::new().into() ] )
    .add_row( vec![ "myapp build --verbose".into(), String::new().into() ] )
    .add_row( vec![ "myapp test --config test.toml".into(), String::new().into() ] )
    .build_view();
  ...
  let config_help = RowBuilder::new( vec![ "Section".into(), "Content".into() ] )
    .add_row( vec![ "USAGE".into(), String::new().into() ] )
    .add_row( vec![ "unikit .config [key::key-name] [format::output-format]".into(), String::new().into() ] )
    .add_row( vec![ "PARAMETERS".into(), String::new().into() ] )
    ...
    .add_row( vec![ "SOURCE TYPES".into(), String::new().into() ] )

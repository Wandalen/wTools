...
| 18 | 018 | 1764 | 7 | 7 | 9 | 4 | 🎯 (In Progress — Phase 4/6) | ai | [Header and footer titled-rule support across formatters](018_heading_footer_multi_formatter.md) | Generalize `Heading` from header-only/Table-only to header+footer across Table/Tree/Expanded/Text/Yaml/Toml/Sql via one shared formatter-agnostic render primitive; Table footer + Tree heading/footer + Expanded heading/footer + Text heading/footer done (979/979 tests, clippy clean) |

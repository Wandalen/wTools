...
| 16 | 016 | 0 | 7 | 6 | 8 | 4 | 🎯 (Verified) | any | [Add feature-gated `quantity` formatting module (duration/age, number, byte size)](016_add_quantity_formatting_module.md) | Fixed 6-visible-char `NNuNNu` duration/age formatter + number/byte formatters, gray unit letters, NO_COLOR/TTY-aware, feature-gated (`quantity`), minor bump 0.8.1→0.9.0; consumer wplan TSK-1509 |

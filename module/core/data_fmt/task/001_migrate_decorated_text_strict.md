# Migrate data_fmt to use DecoratedText strictly — eliminate all raw ANSI String usage
...
- `data_fmt/src/formatters/wrap.rs` and `data_fmt/src/formatters/tree.rs` — not in gap list

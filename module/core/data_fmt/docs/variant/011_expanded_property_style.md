...
| File | Relationship |
|------|-------------|
| [002_expanded_formatter.md](../formatter/002_expanded_formatter.md) | Parent formatter producing this variant |
...
| File | Relationship |
|------|-------------|
| [`tests/expanded_behavior.rs`](../../tests/expanded_behavior.rs) | Expanded formatter behavior tests |

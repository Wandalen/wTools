...
- **Trigger**: A new public API surface area needs documentation (new type, new config group, new formatter set).
...
6. Update the **Instances** count in `docs/entity.md` **Master Doc Entities Table** for the `api/` row.

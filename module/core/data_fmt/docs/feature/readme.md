...
- **In Scope**: Table formatting, word wrap, unified format interface, color themes, auto-fit, API cleanup v0.3.0, heading and footer titled rules, quantity formatting.
...
| 007 | [Heading and Footer Titled Rules](007_table_heading.md) | Titled rule line rendered as header and/or footer across Table/Tree/Expanded/Text/Yaml/Toml/Sql/Html | ✅ |
| 008 | [Quantity Formatting](008_quantity_formatting.md) | Duration/count/byte-size formatting for CLI output | ✅ |

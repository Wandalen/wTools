...
3. Create `docs/builder/NNN_name.md` with the following sections in order per **Type-Specific Requirements** in `readme.md`: `### Scope`, `### Cross-References`, `### Construction API`, `### Invariants`.

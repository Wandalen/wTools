...
- **Purpose**: Provide the arctic-inspired cool Nord palette.
...
| File | Relationship |
|------|-------------|
| [`src/themes.rs`](../../src/themes.rs) | `ColorTheme::nord()` implementation |
...
- **header_color**: `\x1b[38;5;81m` (frost blue)
- **border_color**: `\x1b[38;5;236m` (polar night)
- **row_color1**: `\x1b[0m` (default)
- **row_color2**: `\x1b[48;5;236m` (polar night background)
- **branch_color**: `\x1b[38;5;150m` (frost green)

### Visual Characteristics

- **color_depth**: 256-color (38;5;N)
- **contrast_profile**: Low-contrast
...
| Role | ANSI SGR |
|------|----------|
| Header / key | `\x1b[38;5;81m` |
| Border / separator | `\x1b[38;5;236m` |
| Row 1 | `\x1b[0m` |
| Row 2 (background) | `\x1b[48;5;236m` |
| Tree branch | `\x1b[38;5;150m` |

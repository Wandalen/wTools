...
- **Purpose**: Provide the low-contrast Solarized scientific palette.
...
| File | Relationship |
|------|-------------|
| [`src/themes.rs`](../../src/themes.rs) | `ColorTheme::solarized()` implementation |
...
- **header_color**: `\x1b[33m` (yellow)
- **border_color**: `\x1b[38;5;240m` (Solarized base01)
- **row_color1**: `\x1b[38;5;234m` (Solarized base03)
- **row_color2**: `\x1b[48;5;235m` (Solarized base02 background)
...
- **constructor**: `ColorTheme::solarized()`
- **builder_pattern**: No
...
|------|----------|
| Header / key | `\x1b[33m` |
| Border / separator | `\x1b[38;5;240m` |
| Row 1 | `\x1b[38;5;234m` |

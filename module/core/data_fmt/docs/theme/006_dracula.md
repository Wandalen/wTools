...
- **Purpose**: Provide a dark palette with vibrant accent colors.
...
| File | Relationship |
|------|-------------|
| [`src/themes.rs`](../../src/themes.rs) | `ColorTheme::dracula()` implementation |
...
- **header_color**: `\x1b[38;5;141m` (purple)
- **border_color**: `\x1b[38;5;61m` (comment gray)
- **row_color1**: `\x1b[38;5;231m` (foreground white)
- **row_color2**: `\x1b[48;5;236m` (selection background)
- **branch_color**: `\x1b[38;5;212m` (pink)
...
- **constructor**: `ColorTheme::dracula()`
- **builder_pattern**: No
...
| Role | ANSI SGR |
|------|----------|
| Header / key | `\x1b[38;5;141m` |
| Border / separator | `\x1b[38;5;61m` |
| Row 1 | `\x1b[38;5;231m` |
| Row 2 (background) | `\x1b[48;5;236m` |
| Tree branch | `\x1b[38;5;212m` |

mod private
{
  ...
  pub fn workflow_generate( base_path: &Path ) -> Result< () >
  {
    ...
    handlebars.register_template_string( "appropraite_branch_for", include_str!( "../../files/template/appropraite_branch_for.hbs" ) )?;
    handlebars.register_template_string( "auto_merge_to", include_str!( "../../files/template/auto_merge_to.hbs" ) )?;
    handlebars.register_template_string( "standard_rust_pull_request", include_str!( "../../files/template/standard_rust_pull_request.hbs" ) )?;
    handlebars.register_template_string( "module_push", include_str!( "../../files/template/module_push.hbs" ) )?;
    ...
    file_write( &workflow_root.join( "AutoPr.yml" ), include_str!( "../../files/static/auto_pr.yml" ) )?;

...
pub( crate ) mod private
{
  ...
  pub fn ca() -> CommandsAggregatorFormer
  {
    ...
    .command( "test" )
      ...
      .property( "include" )
        .hint( "A list of features to include in testing. Separate multiple features by comma. Default id empty." )
        .kind( Type::List( Type::String.into(), ',' ) )
        .optional( true )
        .end()
      .property( "exclude" )
        .hint( "A list of features to exclude from testing. Separate multiple features by comma. Default id empty." )
        .kind( Type::List( Type::String.into(), ',' ) )
        .optional( true )
        .end()
      ...
      .property( "with_nightly" )
        .hint( "Specifies whether or not to run tests on nightly Rust version. Default is `true`." )
        .kind( Type::Bool )
        .optional( true )
        .end()
      .property( "concurrent" )
      ...
      .property( "enabled_features")
        .hint( "This features will be always present in feature's combinations. Default id empty.")
        .kind( Type::List( Type::String.into(), ',' ) )
        .optional( true )
        .end()
      ...
      .property( "with_release" )
        .hint( "Indicates whether or not tests will be run on the release optimization. Default is `true`." )
        .kind( Type::Bool )
        .optional( true )
        .end()
      .property( "with_debug" )

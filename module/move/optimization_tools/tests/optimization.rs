...
#[ test ]
fn time_measure_params()
{
  use params_variation::*;

  let durations1 = get_time_for_step( | cooling_factor |
  {
    let easy : &str = r#"
    350964170
    700020003
    ...
    170039406
    "#;
    let mut initial = SudokuInitial::new( Board::from( easy ), Seed::default() );
  ...
  let durations2 = get_time_for_input( | cooling_factor |
  {
    let easy : &str = r#"
    350964170
    700020003
  ...
  }, vec![ 0.002, 0.0022, 0.0024, 0.0026, 0.0028 ], Duration::new( 60, 0 ), 10 );
  assert_eq!( durations1, durations2 );
}

// #[ test ]
// fn time_measure_resets()
// {
//   use params_variation::*;
...
//   }, vec![ 10000, 500, 20, 1200 ], Duration::new( 60, 0 ), 10 );
//   assert_eq!( durations, Vec::new() );
// }
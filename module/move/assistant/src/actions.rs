...
impl fmt::Display for OpenAiListAssistantsReport 
{
    ...
    {
        writeln!("{}", AsTable::new( &self.assistants ).table_to_string_with_format( &output_format::Table::default() ) )
    }
}
...
impl fmt::Display for OpenAiListFilesReport 
{
    fn fmt( &self, f : &mut fmt::Formatter< '_ >) -> Result< (), fmt::Error >
    {
        writeln!("{}", AsTable::new( &self.files ).table_to_string_with_format( &output_format::Table::default() ) )
    }
}
...
impl fmt::Display for OpenAiListRunsReport 
{
    fn fmt( &self, f : &mut fmt::Formatter< '_ >) -> Result< (), fmt::Error >
    {
        writeln!("{}", AsTable::new( &self.runs ).table_to_string_with_format( &output_format::Table::default() ) )
    }
}

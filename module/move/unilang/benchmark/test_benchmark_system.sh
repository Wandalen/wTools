...
echo "  ./benchmark/run_comprehensive_benchmark.sh"
echo "  ./benchmark/run_all_benchmarks.sh"
echo ""
echo "📋 Individual benchmarks (all ignored by default):"
echo "  cargo test exponential_performance_benchmark --release --features benchmarks -- --ignored"
echo "  cargo test framework_comparison_benchmark --release --features benchmarks -- --ignored"

...
/// What is measured: fn `benchmark_unilang_comprehensive`( `command_count` : usize ) -> `ComprehensiveBenchmarkResult`
/// How to measure: cargo bench --bench `comprehensive_benchmark` --features benchmarks
/// Measuring: Unilang command registry init time, lookup performance, and throughput vs Clap/Pico-Args
#[ cfg( feature = "benchmarks" ) ]
...
/// What is measured: fn `benchmark_clap_comprehensive`( `command_count` : usize ) -> `ComprehensiveBenchmarkResult`
/// How to measure: cargo bench --bench `comprehensive_benchmark` --features benchmarks
/// Measuring: Clap command registry init time, argument parsing performance vs Unilang/Pico-Args
#[ cfg( feature = "benchmarks" ) ]
...
/// What is measured: fn `benchmark_pico_args_comprehensive`( `command_count` : usize ) -> `ComprehensiveBenchmarkResult`
/// How to measure: cargo bench --bench `comprehensive_benchmark` --features benchmarks
/// Measuring: Pico-args argument parsing init time, lookup performance vs Unilang/Clap
#[ cfg( feature = "benchmarks" ) ]
...
fn main() {
        ...
        for result_set in &all_results {
            for result in result_set {
                ...
                if result.init_time_us >= 200_000.0 {
...
#[ cfg( feature = "benchmarks" ) ]
fn run_unilang_small_commands_benchmark() {
  use unilang::benchmark_data_sizes::BenchmarkDataSize;
  let result = benchmark_unilang_comprehensive(BenchmarkDataSize::Small.value());
  core::hint::black_box(result);
}

#[ cfg( feature = "benchmarks" ) ]
fn run_clap_small_commands_benchmark() {
  use unilang::benchmark_data_sizes::BenchmarkDataSize;
  let result = benchmark_clap_comprehensive(BenchmarkDataSize::Small.value());
  core::hint::black_box(result);
}

#[ cfg( feature = "benchmarks" ) ]
fn run_pico_args_small_commands_benchmark() {
  use unilang::benchmark_data_sizes::BenchmarkDataSize;
  let result = benchmark_pico_args_comprehensive(BenchmarkDataSize::Small.value());
  core::hint::black_box(result);
}

#[ cfg( feature = "benchmarks" ) ]
fn run_unilang_medium_commands_benchmark() {
  use unilang::benchmark_data_sizes::BenchmarkDataSize;
  let result = benchmark_unilang_comprehensive(BenchmarkDataSize::Medium.value());
  core::hint::black_box(result);
}

#[ cfg( feature = "benchmarks" ) ]
fn run_clap_medium_commands_benchmark() {
  use unilang::benchmark_data_sizes::BenchmarkDataSize;
  let result = benchmark_clap_comprehensive(BenchmarkDataSize::Medium.value());
  core::hint::black_box(result);
}

#[ cfg( feature = "benchmarks" ) ]
fn run_pico_args_medium_commands_benchmark() {
  use unilang::benchmark_data_sizes::BenchmarkDataSize;
  let result = benchmark_pico_args_comprehensive(BenchmarkDataSize::Medium.value());
  core::hint::black_box(result);
}

// Large (1000) command benchmarks
#[ cfg( feature = "benchmarks" ) ]
fn run_unilang_large_commands_benchmark() {
  use unilang::benchmark_data_sizes::BenchmarkDataSize;
  let result = benchmark_unilang_comprehensive(BenchmarkDataSize::Large.value());
  core::hint::black_box(result);
}

#[ cfg( feature = "benchmarks" ) ]
fn run_clap_large_commands_benchmark() {
  use unilang::benchmark_data_sizes::BenchmarkDataSize;
  let result = benchmark_clap_comprehensive(BenchmarkDataSize::Large.value());
  core::hint::black_box(result);
}

#[ cfg( feature = "benchmarks" ) ]
fn run_pico_args_large_commands_benchmark() {
  use unilang::benchmark_data_sizes::BenchmarkDataSize;
  let result = benchmark_pico_args_comprehensive(BenchmarkDataSize::Large.value());
  core::hint::black_box(result);
}

// Huge (10000) command benchmarks
#[ cfg( feature = "benchmarks" ) ]
fn run_unilang_huge_commands_benchmark() {
  use unilang::benchmark_data_sizes::BenchmarkDataSize;
  let result = benchmark_unilang_comprehensive(BenchmarkDataSize::Huge.value());
  core::hint::black_box(result);
}

#[ cfg( feature = "benchmarks" ) ]
fn run_clap_huge_commands_benchmark() {
  use unilang::benchmark_data_sizes::BenchmarkDataSize;
  let result = benchmark_clap_comprehensive(BenchmarkDataSize::Huge.value());
  core::hint::black_box(result);
}

#[ cfg( feature = "benchmarks" ) ]
fn run_pico_args_huge_commands_benchmark() {
  use unilang::benchmark_data_sizes::BenchmarkDataSize;
  let result = benchmark_pico_args_comprehensive(BenchmarkDataSize::Huge.value());
  core::hint::black_box(result);
}

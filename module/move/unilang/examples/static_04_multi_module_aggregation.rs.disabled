...
fn main() -> Result< (), unilang::Error >
{
  ...
  let builder = CliBuilder::new()
    .add_static_module( "file_ops", "commands/file_commands.yaml" )
    .add_static_module( "network", "commands/network_commands.yaml" )
    .add_static_module( "database", "commands/db_commands.yaml" )
  ...
  let registry = StaticCommandRegistry::from_phf( &super::STATIC_COMMANDS );

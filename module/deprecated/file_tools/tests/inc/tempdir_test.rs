...
fn create_creates_directory()
{
  ...
  temp_dir.postfix_path = PathBuf::from( format!( "file_tools_create_test_{}", std::process::id() ) );
...
fn create_all_creates_nested_directories()
{
  let mut temp_dir = the_module::TempDir::new();
  temp_dir.base_path = std::env::temp_dir();
  temp_dir.prefix_path = PathBuf::from( format!( "file_tools_nested_{}", std::process::id() ) );
...
fn create_all_idempotent()
{
  let mut temp_dir = the_module::TempDir::new();
  temp_dir.base_path = std::env::temp_dir();
  temp_dir.prefix_path = PathBuf::from( format!( "file_tools_idem_{}", std::process::id() ) );
...
fn drop_cleans_up_created_directory()
{
...

  {
    let mut temp_dir = the_module::TempDir::new();
    temp_dir.base_path = std::env::temp_dir();
    temp_dir.prefix_path = PathBuf::from( format!( "file_tools_drop_{}", std::process::id() ) );
...
fn drop_does_not_cleanup_manual_paths()
{
  ...
  let manual_path = std::env::temp_dir().join( format!( "file_tools_manual_{}", std::process::id() ) );
...
fn drop_handles_already_deleted()
{
  let mut temp_dir = the_module::TempDir::new();
  temp_dir.base_path = std::env::temp_dir();
  temp_dir.prefix_path = PathBuf::from( format!( "file_tools_predelete_{}", std::process::id() ) );

...
mod collection_constructor_edge_cases
{
  ...
  fn test_empty_heap()
  {
    let h : std::collections::BinaryHeap< i32 > = heap!();
    assert_eq!( h.len(), 0 );
    assert!( h.is_empty() );
  }
  ...
  fn test_empty_hmap()
  {
    let m : test_tools::HashMap< i32, &str > = hmap!();
    assert_eq!( m.len(), 0 );
    assert!( m.is_empty() );
  }
  ...
  fn test_empty_hset()
  {
    let s : test_tools::HashSet< i32 > = hset!();
    assert_eq!( s.len(), 0 );
    assert!( s.is_empty() );
  }
  ...
  fn test_empty_dlist()
  {
    let l : std::collections::VecDeque< i32 > = dlist!();
    assert_eq!( l.len(), 0 );
    assert!( l.is_empty() );
  }
  ...
  fn test_empty_bmap()
  {
    let m : std::collections::BTreeMap< i32, &str > = bmap!();
    assert_eq!( m.len(), 0 );
    assert!( m.is_empty() );
  }
  ...
  fn test_empty_bset()
  {
    let s : std::collections::BTreeSet< i32 > = bset!();
    assert_eq!( s.len(), 0 );
    assert!( s.is_empty() );
  }
  ...
  fn test_vec_macro_disambiguation()
  {
    ...
    assert_eq!( core::any::type_name_of_val( &v1 ), core::any::type_name_of_val( &v2 ) );
  }
}

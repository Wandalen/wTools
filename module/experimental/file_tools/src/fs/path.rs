...
//!
//! Consumer crates now re-export from `file_tools::path` as the single source of truth,
...
mod private
{
  ...
  /// # {
  /// use file_tools::path::traverse_upward;
  /// use std::path::Path;
  ///
  ...
  /// # #[cfg(all(feature = "enabled", not(feature = "no_std")))]
  /// # {
  /// use file_tools::path::collect_files_in_ancestors;
  /// use std::path::Path;
  ///
  ...
  /// # #[cfg(all(feature = "enabled", not(feature = "no_std")))]
  /// # {
  /// use file_tools::path::file_upward_find;
  /// use std::path::Path;
  ///
  ...
  /// # #[cfg(all(feature = "enabled", not(feature = "no_std")))]
  /// # {
  /// use file_tools::path::dir_upward_find;
  /// use std::path::Path;
  ///
  ...
  /// # #[cfg(all(feature = "enabled", not(feature = "no_std")))]
  /// # {
  /// use file_tools::path::matching_upward_find;
  /// use std::path::Path;
  ///

...
|------|------|----------------|
| source | `src/_blank/standard_lib.rs` | Placeholder; will house include_md_section! proc-macro entry point |
| test | `tests/section_extraction.rs` (to create) | Test suite covering heading match, boundary, nesting, duplicate, missing heading |
| doc | [api/002_include_md_section.md](../api/002_include_md_section.md) | Macro contract: parameters, heading semantics, error conditions |
...
| doc | [invariant/004_section_extraction_rules.md](../invariant/004_section_extraction_rules.md) | Formal behavioral rules for heading matching and boundary detection |

...
- **Out of Scope**: Ownership system implications for the caller's subsequent use of the value (governed by the language's ordinary ownership rules), values passed to the macro by move from a temporary.

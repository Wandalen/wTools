...
|------|---------|-------------|----------:|
| `api/`       | Index of API doc instances for the implements crate.       | [api/readme.md](api/readme.md)             | 2 |
| `feature/`   | Index of feature doc instances for the implements crate.   | [feature/readme.md](feature/readme.md)     | 1 |
| `invariant/` | Index of invariant doc instances for the implements crate. | [invariant/readme.md](invariant/readme.md) | 3 |
| `pattern/`   | Index of pattern doc instances for the implements crate.   | [pattern/readme.md](pattern/readme.md)     | 1 |

## Master Doc Instances Table

| Entity | ID | Name | File |
|--------|----|------|------|
| api | 001 | implements | [api/001_implements.md](api/001_implements.md) |
| api | 002 | instance_of | [api/002_instance_of.md](api/002_instance_of.md) |

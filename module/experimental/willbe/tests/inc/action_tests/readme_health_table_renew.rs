...
fn branches_cell() 
{
  ...
  // qqq: do not do like that. If it will fail how will I know what went wrong? What is the name of the package here?
  assert!( actual.contains( "[![rust-status](https://img.shields.io/github/actions/workflow/status/SomeCrate/C/workspace_push.yml?label=&branch=test_branch1&job=_willbe_variadic_tag_configurations_full_config_c)](https://github.com/SomeName/SomeCrate/C/actions/workflows/workspace_push.yml?query=branch%3Atest_branch1) | [![rust-status](https://img.shields.io/github/actions/workflow/status/SomeCrate/C/workspace_push.yml?label=&branch=test_branch2&job=_willbe_variadic_tag_configurations_full_config_c)](https://github.com/SomeName/SomeCrate/C/actions/workflows/workspace_push.yml?query=branch%3Atest_branch2)" ) );
}

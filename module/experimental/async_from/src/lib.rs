...
#![ cfg_attr( all( doc, feature = "async_from", feature = "async_try_from" ), doc = include_str!( concat!( env!( "CARGO_MANIFEST_DIR" ), "/", "readme.md" ) ) ) ]
#![ cfg_attr( not( all( doc, feature = "async_from", feature = "async_try_from" ) ), doc = "Async conversion utilities" ) ]

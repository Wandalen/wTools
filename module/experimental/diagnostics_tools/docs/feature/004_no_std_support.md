...
| source | [src/lib.rs](../../src/lib.rs) | Crate entry point; no_std conditional compilation gate |
| test | [tests/smoke_test.rs](../../tests/smoke_test.rs) | Build and feature-flag smoke validation |

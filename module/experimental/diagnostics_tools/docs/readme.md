...
Design and API documentation for `diagnostics_tools`.
...
| [feature/](feature/readme.md) | Runtime, compile-time, memory layout, and no-std features |
| [api/](api/readme.md) | Public assertion macro interface contracts |

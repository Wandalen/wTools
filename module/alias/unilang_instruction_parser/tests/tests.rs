...
#[ path = "../../../../module/core/unilang_parser/tests/parser_config_entry_tests.rs" ]
mod parser_config_entry_tests;

#[ path = "../../../../module/core/unilang_parser/tests/command_parsing_tests.rs" ]
mod command_parsing_tests;

#[ path = "../../../../module/core/unilang_parser/tests/syntactic_analyzer_command_tests.rs" ]
mod syntactic_analyzer_command_tests;

#[ path = "../../../../module/core/unilang_parser/tests/argument_parsing_tests.rs" ]
mod argument_parsing_tests;

#[ path = "../../../../module/core/unilang_parser/tests/comprehensive_tests.rs" ]
mod comprehensive_tests;

#[ path = "../../../../module/core/unilang_parser/tests/error_reporting_tests.rs" ]
mod error_reporting_tests;

#[ path = "../../../../module/core/unilang_parser/tests/spec_adherence_tests.rs" ]

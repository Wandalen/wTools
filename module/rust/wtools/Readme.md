<!-- {{# generate.module_header{ current_dir : "./", type : "rust" } #}} -->
...
<!-- {{# generate.module_sample{ current_dir : "./", sample_dir : "./sample/rust/wtools_trivial_sample", type : "rust" } #}} -->
...
<!-- {{# generate.module_sample{ current_dir : "./", sample_dir : "./sample/rust/wtools_xxx", type : "rust" } #}} -->

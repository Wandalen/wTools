...
tests_impls!
{
  ...
  fn node()
  {
    ...
    let mut factory = TheModule::canonical::NodeFactory::< TheModule::IdentityWithInt >::make();
...
//     a_id!( got, exp );
  ...
  fn make_with_edge_list_string()
  {
    ...
    // let mut factory = TheModule::canonical::NodeFactory::< TheModule::IdentityWithName >::make();

...
fn single_basic_test()
{
  ...
  /* test.case( "from f32 / into Wrap" ) */
  let instance1 : Wrap = ( 13.0 ).into();
  let instance2 = Wrap::from( 13.0 );
  assert_eq!( instance1.0, 13.0 );
  assert_eq!( instance2.0, 13.0 );
  assert_eq!( instance1, instance2 );

  /* test.case( "from itself / into itself" ) */
  let instance1 : Wrap = ( Wrap::from( 13.0 ) ).into();
  let instance2 = Wrap::from( Wrap::from( 13.0 ) );
  assert_eq!( instance1.0, 13.0 );
  assert_eq!( instance2.0, 13.0 );
  assert_eq!( instance1, instance2 );

  /* test.case( "from Wrap / into f32" ) */
  let instance1 : Wrap = ( 13.0 ).into();
...
fn single_parametrized_test()
{
  ...
  /* test.case( "from f32 / into Wrap" ) */
  let instance1 : Wrap< f32 > = ( mod1::Wrap0::from( 13.0 ) ).into();
  let instance2 = Wrap::< f32 >::from( mod1::Wrap0::from( 13.0 ) );
  assert_eq!( instance1.0.0, 13.0 );
  assert_eq!( instance2.0.0, 13.0 );
  assert_eq!( instance1, instance2 );

  /* test.case( "from itself / into itself" ) */
  let instance1 : Wrap< f32 > = ( Wrap::from( mod1::Wrap0::from( 13.0 ) ) ).into();
  let instance2 = Wrap::< f32 >::from( Wrap::from( mod1::Wrap0::from( 13.0 ) ) );
  assert_eq!( instance1.0.0, 13.0 );
  assert_eq!( instance2.0.0, 13.0 );
  assert_eq!( instance1, instance2 );
  ...
  /* test.case( "deref" ) */
  let got : Wrap< f32 > = ( mod1::Wrap0::from( 13.5 ) ).into();
  assert_eq!( got.round(), 14.0 );
...
fn single_parametrized_complex_test()
{
  ...
  single!
  {
    ...
    #[ derive( Debug, Clone ) ]
    #[ derive( PartialEq ) ]
    Wrap : mod1::Wrap0< T : PartialEq + std::marker::Copy >;
...
fn single_parameter_test()
{
  ...
  /* test.case( "from f32 / into Wrap" ) */
  let instance1 : Wrap< f32 > = ( 13.0 ).into();
  let instance2 = Wrap::< f32 >::from( 13.0 );
  assert_eq!( instance1.0, 13.0 );
  assert_eq!( instance2.0, 13.0 );
  assert_eq!( instance1, instance2 );

  /* test.case( "from itself / into itself" ) */
  let instance1 : Wrap< f32 > = ( Wrap::from( 13.0 ) ).into();
  let instance2 = Wrap::< f32 >::from( Wrap::from( 13.0 ) );
  assert_eq!( instance1.0, 13.0 );
  assert_eq!( instance2.0, 13.0 );
  assert_eq!( instance1, instance2 );
...
fn single_parameter_complex_test()
{
  ...
  single!
  {
    ...
    #[ derive( Debug, Clone ) ]
    #[ derive( PartialEq ) ]
    Wrap : < T : core::cmp::PartialEq + core::clone::Clone >;

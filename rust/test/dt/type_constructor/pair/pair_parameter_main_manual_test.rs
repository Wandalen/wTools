...
impl TheModule::Make2< f64, f32 > for Pair1
{
  #[ inline ]
  fn make_2( _0 : f64, _1 : f32 ) -> Self { Self( _0, _1 ) }
}
...
impl TheModule::Make2< f32, f64 > for Pair2
{
  #[ inline ]
  fn make_2( _0 : f32, _1 : f64 ) -> Self { Self( _0, _1 ) }
}
